...
connection_string = "Driver={ODBC Driver 17 for SQL Server};Server=tcp:todoserver90.database.windows.net,1433;Database=tododb;Uid=tani;Pwd=Todo@1234;Encrypt=yes;TrustServerCertificate=no;Connection Timeout=30;"
